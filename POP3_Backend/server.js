...
const handleRetrCommand = require('./commands/RETR');
const handleDeleCommand = require('./commands/DELE');
...
function handleCommand(command, params) {
  switch (command) {
    ...
    case 'RETR':
      return handleRetrCommand(params);
    case 'DELE':
      return handleDeleCommand(params);
    case 'QUIT':
      return '+OK Bye!\r\n';
    default:
...
const port = process.env.POP_PORT;
server.listen(port, () => {
